...
export const likeReducer = createReducer(initialState, (builder) => {
    builder
        ...
        .addCase('deleteCommentReuest', (state) => {
            state.loading = true
        })
...
export const uniquePostReducer = createReducer(initialState,(builder) => {
    builder
            .addCase("uniquePostRequest",(state) => {
                state.loading = true;
            })
            
            .addCase("uniquePostSuccess",(state,action) => {
                state.loading = false;
                state.post = action.payload;
                state.isAuthenticated = true
            })

            .addCase("uniquePostFailure",(state,action) => {
                state.loading = false;
                state.error = action.payload;
            })
